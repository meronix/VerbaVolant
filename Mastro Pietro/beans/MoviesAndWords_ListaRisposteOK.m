//
//  MoviesAndWords_ListaRisposteOK.m
//
...
NSString *const kMoviesAndWords_ListaRisposteOKMovieObj = @"movie_obj";


@interface MoviesAndWords_ListaRisposteOK ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MoviesAndWords_ListaRisposteOK
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    NSObject *receivedMoviesAndWords_MovieObj = [dict objectForKey:kMoviesAndWords_ListaRisposteOKMovieObj];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForMovieObj] forKey:kMoviesAndWords_ListaRisposteOKMovieObj];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.movieObj = [aDecoder decodeObjectForKey:kMoviesAndWords_ListaRisposteOKMovieObj];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_movieObj forKey:kMoviesAndWords_ListaRisposteOKMovieObj];
}

- (id)copyWithZone:(NSZone *)zone
{
    MoviesAndWords_ListaRisposteOK *copy = [[MoviesAndWords_ListaRisposteOK alloc] init];
