//
//  MoviesAndWords_ListaRisposteKO.m
//
...
NSString *const kMoviesAndWords_ListaRisposteKOMovieObj = @"movie_obj";


@interface MoviesAndWords_ListaRisposteKO ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation MoviesAndWords_ListaRisposteKO
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    NSObject *receivedMoviesAndWords_MovieObj = [dict objectForKey:kMoviesAndWords_ListaRisposteKOMovieObj];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForMovieObj] forKey:kMoviesAndWords_ListaRisposteKOMovieObj];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.movieObj = [aDecoder decodeObjectForKey:kMoviesAndWords_ListaRisposteKOMovieObj];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_movieObj forKey:kMoviesAndWords_ListaRisposteKOMovieObj];
}

- (id)copyWithZone:(NSZone *)zone
{
    MoviesAndWords_ListaRisposteKO *copy = [[MoviesAndWords_ListaRisposteKO alloc] init];
